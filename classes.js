class Sprite {
    ...
    draw() {
        ...
        this.image, 
        this.frames.val * this.width,                         // обрезаем картинку (4 аргумента)
        0,
...
class Monster extends Sprite {
    constructor ({
        name, isEnemy = false, position, image, frames = { max: 1, hold: 10 }, sprites, animate = false, rotation = 0, attacks
    }) {
        super({
